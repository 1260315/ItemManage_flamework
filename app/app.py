    ...
    if step == "upload":
        ...
        if not files:
            ...
            return render_template(
                "P010-2_import_file_format_error.html",
        ...
        if invalid_files:
            ...
            return render_template("P010-2_import_file_format_error.html", invalid_files=invalid_files)
        ...
        for p in temp_paths:
            try:
                ...
                # ファイルが空だった場合
                return render_template(
                    "P010-4_import_file_data_error.html",
        ...
        # 成功・失敗どちらも表示
        return render_template("P010-4_import_complete.html",
